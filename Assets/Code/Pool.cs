...
namespace TankGame
{
        ...
        where T : Component
    {
        ...
        private T AddObject(bool isActive = false)
        {
            ...
            T t = Object.Instantiate(_objectPrefab);
        ...
        /// </summary>
        /// <param name="t">Object to deactivate</param>
        protected virtual void Deactivate(T t)
        {
        ...
        /// </summary>
        /// <param name="t">Object to activate</param>
        protected virtual void Activate(T t)
        {
        ...
        /// </summary>
        /// <param name="t">The object which should be returned to the pool.</param>
